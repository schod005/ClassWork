...
class DHTNode_SupernodeInterfaceHandler : virtual public DHTNode_SupernodeInterfaceIf {
 ...
 public:
  ...
  void getNode(NodeInfo& _return) {
    ...
    _return = (DHTNodes.size() > 1 ? DHTNodes[rand()%(DHTNodes.size())] : (DHTNodes.size() == 1 ? DHTNodes[0] : empty));
    printf("getNode\n");
  }
...
int main(int argc, char **argv) {
  ...
  std::cout << std::endl << "Here is my IP: <" << getIPAddress() << "> and port: " << port << std::endl;
  std::cout << std::endl << "Now serving nodes and clients" << std::endl;
  server.serve();
  return 0;
}
