...
# 4552990
#
# Since I'm not using ILEAVE, I didn't implement it.
# 
# For IADDL, I added the IIADDL in all the necessary places for the
# pipeline to function properly when using the instruction.
#
# In the fetch stage, I added it as a valid instruction and specified
# that regIDs are needed as well as valC
#
# In the decode stage, I specified that srcB and destE should both be rB
#
# In the Execute stage, I specified that aluA should be valC and aluB
# should be valB
#
# No changes to the Memory stage
#
#
#/* $begin pipe-all-hcl */
####################################################################
