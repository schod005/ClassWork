...
int main(int argc, char **argv) {
  ...
  //ask for file
  sendto(sockfd, (void *)&send_msg, msg_tLEN, 0, (struct sockaddr *)&serveraddr, serverLEN);
  if (n < 0) 
  ...
  while(1)
  {
    ...
    n = recvfrom(sockfd, (void *)&receive_msg, msg_tLEN, 0, (struct sockaddr *)&clientaddr, &serverLEN);
    ...
    if(receive_msg.msg_type == MSG_TYPE_FINISH)
      break;
  }
